...
[Click here to finish setting up your workspace!](https://cloud.nx.app/connect/TwEllYlyOS)
...
```sh
npx nx serve rn-mono
```

To create a production bundle:

```sh
npx nx build rn-mono
```

To see all available targets to run for a project, run:

```sh
npx nx show project rn-mono
```
